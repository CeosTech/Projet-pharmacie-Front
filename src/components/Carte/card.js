...
const Card = ({
  ...
  const handleChangeSupplement = (event) => {
    ...
    if (testCompteur === true) {
      ...
      tabSupplement = Object.assign([], tabSupplement)
  ...
  const handleChangeSauce = (event) => {
    ...
    if (testCompteur === true) {
      compteurDouble += 1;
      tabSauce = Object.assign([], tabSauce)
      tabSauce.push(event.target.value);
      console.log(compteurDouble)
      ...
      compteurDouble > 0 && (compteurDouble -= 1);
...
/*================= VERIFICATION MENUS AU FOUR */
    ...
    } else if ((data.categorie === 5 || data.categorie === 1) && (data.id === 98 || data.id === 11 || data.id === 23)) {
      if (
        viande_2_Selected !== null && tabViande_2.length === 2
      ) {
        if (
      ...
      <div>
        ...
        >
          <Modal.Header>
            ...
            {data.categorie == 9 || data.categorie == 10 || data.categorie == 11 ? (
                <p>{splitPrix(choixTaille[0].prix)}</p>
            ) : <p>{splitPrix(prix)}</p> }
          ...
          {(data.categorie === 5 && data.id === 98) || 
           (data.categorie === 1 && (data.id === 11 || data.id === 23)) ? (
            <>
              <Modal.Body.Heading
                style={{ marginBottom: "1.5rem", marginTop: "1.3rem" }}
              >
          ...
          data.categorie == 24? (
            <>
              <Modal.Body.Heading
                style={{ marginBottom: "1.5rem", marginTop: "1.3rem" }}
              >
                {data.categorie == 5 || data.categorie == 2 ? "Sauce(s)" : "Sauce(s) pour les frites"}
              </Modal.Body.Heading>
              <FormControl component="fieldset">
                <FormGroup>
                  {choixSauce.map((data) => {
